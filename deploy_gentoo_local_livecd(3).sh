...
/usr/local/bin/emerge-auto sys-kernel/vanilla-sources sys-apps/pciutils sys-apps/usbutils dev-lang/python
...
require-installed sys-kernel/vanilla-sources "needed to build the kernel"
