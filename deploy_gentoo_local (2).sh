...
# Stock /etc/profile.d/*.sh scripts (e.g. debuginfod.sh) reference variables
# like \${DEBUGINFOD_URLS} without a default. Under our -u (nounset), sourcing
# /etc/profile as-is aborts the whole install. Relax nounset just for this.
set +u
source /etc/profile
set -u
